...
Suppose you had a point and a list of other points and you wanted to find the
...
In practice, repeated expressions may not be as obvious as in this example. As a
